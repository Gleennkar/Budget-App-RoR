...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference("Contract.count") do
      post contracts_url, params: { contract: { amount: @contract.amount, author_id: @contract.author_id, name: @contract.name } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { amount: @contract.amount, author_id: @contract.author_id, name: @contract.name } }
